    ...
    <div>
        ...
        <div style="margin-top: 10px">
            <el-table :data="salaries" border stripe>
                ...
                <el-table-column label="理疗保险" align="center">
        ...
        <el-dialog
                ...
                <div style="display: flex;justify-content: space-around;align-items: center">
                    ...
                    <!--对象遍历：v-for="(value,title,index)" 中 value表示对象的value,title表示对象的key-->
                    <el-input v-model="salary[title]" :placeholder="'请输入'+salaryItemName[index]+'...'" v-for="(item,title,index) in salary" :key="index"
