    ...
    <div>
        <div>
            <el-table :data="emps" border stripe size="mini">
                ...
                <el-table-column prop="phone" label="电话号码" fixed width="120" align="left"></el-table-column>
                <el-table-column prop="department.name" label="所属部门" fixed width="120" align="left"></el-table-column>
        ...
        methods: {
            ...
            hidePop(data){
                if (this.currentSalaries  ){
                    this.putRequest('/sal/sobcfg/?eid=' + data.id + '&sid=' + this.currentSalaries).then(resp=>{
                        if (resp){
                            this.initEmps();
                        }
                    })
